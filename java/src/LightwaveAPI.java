...
public class LightwaveAPI {
	...
	public static void main(String[] args) {	
		...
		for (int tempcount = 1; tempcount<(60); tempcount++){
			pollEnergyMonitor();    // Poll wireless energy monitor attached to LighwaveRF Wifi hub
			littlePause (1*1000);	// Wait about a second		
		}
	 ...
	 */
	public static void pollEnergyMonitor(){
		...
		// Add a timestamp to response message.  Probably a simpler more elegant way to do this.  TBD.
